    ...
    <nav className="fixed top-4 left-4 right-4 z-50 mx-auto shadow-md rounded-2xl bg-[#7a9e96]/25 backdrop-blur-md border border-white/20 px-6 py-3 flex justify-between items-center overflow-hidden">
      ...
      <div className="relative flex items-center gap-2 cursor-pointer">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-xs font-bold uppercase tracking-widest bg-red-500 border border-red-400 text-white hover:bg-red-600 hover:border-red-500 transition-all cursor-pointer"
        >
